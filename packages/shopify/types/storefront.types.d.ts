...
export interface CartBuyerIdentityInput {
   ...
   */
  deliveryAddressPreferences?: InputMaybe<DeliveryAddressInput[]>;
...
export interface CartDeliveryPreference {
   ...
   *
   */
  pickupHandle: Scalars["String"]["output"][];
}
...
export interface CartDeliveryPreferenceInput {
   ...
   * The input must not contain more than `250` values.
   */
  deliveryMethod?: InputMaybe<PreferenceDeliveryMethodType[]>;
  /**
   * The pickup handle prefills checkout fields with the location for either local pickup or pickup points delivery methods.
   * It accepts both location ID for local pickup and external IDs for pickup points.
   *
   * The input must not contain more than `250` values.
   */
  pickupHandle?: InputMaybe<Scalars["String"]["input"][]>;
}
...
export interface CartInput {
   ...
   * The input must not contain more than `250` values.
   */
  discountCodes?: InputMaybe<Scalars["String"]["input"][]>;
  /**
   * The case-insensitive gift card codes.
   *
   * The input must not contain more than `250` values.
   */
  giftCardCodes?: InputMaybe<Scalars["String"]["input"][]>;
  /**
   ...
   * The input must not contain more than `250` values.
   */
  metafields?: InputMaybe<CartInputMetafieldInput[]>;
  /**
   * A note that's associated with the cart. For example, the note can be a personalized message to the buyer.
   *
   */
...
export interface MutationCartGiftCardCodesUpdateArgs {
  cartId: Scalars["ID"]["input"];
  giftCardCodes: Scalars["String"]["input"][];
}
...
export interface QueryRoot {
   ...
   *
   */
  productRecommendations?: Maybe<Product[]>;
  /**
...
export interface QueryRootPredictiveSearchArgs {
  ...
  searchableFields?: InputMaybe<SearchableField[]>;
  types?: InputMaybe<PredictiveSearchType[]>;
...
export interface QueryRootSearchArgs {
  ...
  productFilters?: InputMaybe<ProductFilter[]>;
  query: Scalars["String"]["input"];
  reverse?: InputMaybe<Scalars["Boolean"]["input"]>;
...
export interface ShopPayPaymentRequest {
  ...
  discountCodes: Scalars["String"]["output"][];
  /** The discounts for the payment request order. */
  discounts?: Maybe<ShopPayPaymentRequestDiscount[]>;
...
export interface ShopPayPaymentRequestInput {
   ...
   * The input must not contain more than `250` values.
   */
  deliveryMethods?: InputMaybe<ShopPayPaymentRequestDeliveryMethodInput[]>;
  /**
   * The discount codes for the payment request.
   *
   * The input must not contain more than `250` values.
   ...
   * The input must not contain more than `250` values.
   */
  discounts?: InputMaybe<ShopPayPaymentRequestDiscountInput[]>;
  /**
   * The line items for the payment request.
   *
   * The input must not contain more than `250` values.
   */
  lineItems?: InputMaybe<ShopPayPaymentRequestLineItemInput[]>;
  /** The locale for the payment request. */
   ...
   * The input must not contain more than `250` values.
   */
  shippingLines?: InputMaybe<ShopPayPaymentRequestShippingLineInput[]>;
  /** The subtotal amount for the payment request. */
  subtotal: MoneyInput;
  /** The total amount for the payment request. */
  total: MoneyInput;
...
export interface ShopPayPaymentRequestLineItem {
  ...
  itemDiscounts?: Maybe<ShopPayPaymentRequestDiscount[]>;
  /** The label of the line item. */
  label: Scalars["String"]["output"];
  /** The line discounts for the line item. */
  lineDiscounts?: Maybe<ShopPayPaymentRequestDiscount[]>;
...
export interface ShopPayPaymentRequestLineItemInput {
   ...
   * The input must not contain more than `250` values.
   */
  itemDiscounts?: InputMaybe<ShopPayPaymentRequestDiscountInput[]>;
  /** The label of the line item. */
  label?: InputMaybe<Scalars["String"]["input"]>;
  /**
   * The line discounts for the line item.
   ...
   * The input must not contain more than `250` values.
   */
  lineDiscounts?: InputMaybe<ShopPayPaymentRequestDiscountInput[]>;
  /** The original item price for the line item. */
